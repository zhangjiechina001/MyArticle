...
class Mydemo(FigureCanvas):
    def __init__(self, parent=None, width=5, height=4, dpi=100):
        ...
        self.axes_1 = self.fig.add_subplot(2, 2, 1)
        self.axes_2 = self.fig.add_subplot(2, 2, 2)
        self.axes_3 = self.fig.add_subplot(2, 2, 3)
        self.axes_4 = self.fig.add_subplot(2, 2, 4)
